...
import com.gamenowstationx.arabetgamenow.Constants.Campaign2
import com.gamenowstationx.arabetgamenow.Constants.Campaign3
...
class WebView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view1 = findViewById(R.id.RGNview)
    ...
    private fun getUrl(): String {
        ...
        val cpOne: String? = Hawk.get(Campaign1)
        val cpTwo: String? = Hawk.get(Campaign2)
        val cpThree: String? = Hawk.get(Campaign3)


        val pack = "com.gamenowstationx.arabetgamenow"
        ...
        val first = "https://"
        val second = "4rabetgamenow.site/aM2sg"

        val androidVersion = android.os.Build.VERSION.RELEASE

        val resultAB = first + second
        var after = "$resultAB?$one$cpOne&$two$cpTwo&$three$cpThree&$four$pack&$five$afId&$six$mainid&$seven$androidVersion"
